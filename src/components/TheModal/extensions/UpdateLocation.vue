...
const handleUpdateLocation = () => {
  ...
  locationsStore.updateLocation({ id: data.id, country: form.city.value, city: form.country.value })
  uiStore.closeModal()
}
</script>
...
<template>
  ...
  <div class="close">
    <TheButton @click="uiStore.closeModal" :variant="E_ButtonVariant.ghost">
      <FA icon="fa-solid fa-pizza-slice" />
    </TheButton>
  </div>
  <div class="actions">
    <TheButton @click="handleUpdateLocation">UPDATE</TheButton>
